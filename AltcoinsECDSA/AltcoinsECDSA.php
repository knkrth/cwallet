...
class AltcoinsECDSA
{
	...
	public function useAlt($alt)
	{
		switch ($alt)
		{
			...
			case '<?php echo $short;?>':
				...
				$this->networkPrefix = $this->prefixes['main']; 
				$this->messageMagic = "<?php echo $fullname;?> Signed Message:\n";
				$this->label = "<?php echo $fullname;?>";	
				return true;
		}
    ...
    public function __construct($alt = '<?php echo $short;?>')
    {
